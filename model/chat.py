...
#     class Meta:
#         fields = ("id", "title", "created_at", "conversations")
#         model = Chat
...
# # Create a single chat schema instance
# chat_schema = ChatSchema()
# # Create multiple chat schema instances
# chats_schema = ChatSchema(many=True)

# # Create a single conversation schema instance
# conversation_schema = ConversationSchema()
# # Create multiple conversation schema instances
